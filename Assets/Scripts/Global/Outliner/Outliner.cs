...
public class Outliner : MonoBehaviour
{
    ...
    Renderer CreateOutline(Material outlineMat, float scaleFactor, Color color)
    {
        ...
        if (outlineObject.GetComponent<TransmutationAmulet>() != null) { outlineObject.GetComponent<TransmutationAmulet>().enabled = false; }
        if (outlineObject.GetComponent<CapsuleCollider>() != null) { outlineObject.GetComponent<CapsuleCollider>().enabled = false; }
