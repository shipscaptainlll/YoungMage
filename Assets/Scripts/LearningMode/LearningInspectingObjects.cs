...
public class LearningInspectingObjects : MonoBehaviour, ILearningQuest
{
    ...
    public void ShowNextStep()
    {
        ...
        } else if (m_nextStep == 3)
        {
            ...
            m_learningPopupsInstantiator.ActivatePopup("woooow6");
            m_tutorialsInstantiator.ActivateTutorial(9);
    ...
    public void CheckScannnerEqquiped()
    {
        if (m_quickAccessHandController.CurrentCustomID == 27)
        {
            ShowNextStep();
        }
    }
