...
public class StoneHandsProcessor : MonoBehaviour, IProcessorPanel
{
    [SerializeField] int customID;
    [SerializeField] Button createButton;
    [SerializeField] StoneOreCounter resourceCounter;
    [SerializeField] StoneHandsCounter productCounter;
